...
export const Filters: React.FC<Props> = ({ className }) => {
  return (
    <div className={cn('min-w-[185px]', className)}>
      <Title text="Filters" size="sm" className="mb-3 font-bold border-b border-b-neutral-100 pb-2" />
      ...
      <div className="border-b border-b-neutral-100 pb-3">
        <FilterCheckbox
          ...
          endAdornment={
            <span className="ml-2 rounded px-1.5 py-0.5 text-xs text-ring border rounded-sm border-ring">% OFF</span>
          }
        />
      </div>
